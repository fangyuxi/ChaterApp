...
public class PermissionsFragment extends BottomSheetDialogFragment implements
    ...
    private void refreshState(View root){
        ...
        root.findViewById(R.id.im_state_permission_record_audio)
                .setVisibility(havaRecordAudioPerm(context) ? View.VISIBLE : View.GONE);
    }
     ...
     * @return True则有
     */
    private static boolean havaRecordAudioPerm(Context context){
        String[] perms = new String[]{
